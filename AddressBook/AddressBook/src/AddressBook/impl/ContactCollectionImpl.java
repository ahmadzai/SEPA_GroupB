 ...
 * <ul>
 *   <li>{@link AddressBook.impl.ContactCollectionImpl#getPersons <em>Persons</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContactCollectionImpl extends EObjectImpl implements ContactCollection {
	...
	public EList<Person> getPersons() {
		if (persons == null) {
			persons = new EObjectContainmentEList<Person>(Person.class, this, AddressBookPackage.CONTACT_COLLECTION__PERSONS);
		}
		return persons;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AddressBookPackage.CONTACT_COLLECTION__PERSONS:
