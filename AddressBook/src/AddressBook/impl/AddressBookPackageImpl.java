...
public class AddressBookPackageImpl extends EPackageImpl implements AddressBookPackage {
	 ...
	 * @generated
	 */
	public EReference getContactCollection_Persons() {
	 ...
	 * @generated
	 */
	public EAttribute getPerson_ApartNr() {
	 ...
	 * @generated
	 */
	public EAttribute getPerson_Coments() {
	...
	public void createPackageContents() {
		...
		createEReference(contactCollectionEClass, CONTACT_COLLECTION__PERSONS);
		...
		createEAttribute(personEClass, PERSON__APART_NR);
		createEAttribute(personEClass, PERSON__POSTAL_CODE);
		createEAttribute(personEClass, PERSON__COMENTS);
	...
	public void initializePackageContents() {
		...
		initEReference(getContactCollection_Persons(), this.getPerson(), null, "persons", null, 0, -1, ContactCollection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getPerson_Fax(), ecorePackage.getEString(), "fax", null, 1, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getPerson_Country(), ecorePackage.getEString(), "country", null, 1, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getPerson_ApartNr(), ecorePackage.getEString(), "apartNr", null, 1, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getPerson_PostalCode(), ecorePackage.getEString(), "postalCode", null, 1, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getPerson_Coments(), ecorePackage.getEString(), "coments", null, 1, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getPerson_Group(), ecorePackage.getEString(), "group", null, 1, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
