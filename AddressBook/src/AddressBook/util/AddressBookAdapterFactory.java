...
public class AddressBookAdapterFactory extends AdapterFactoryImpl {
	...
	protected AddressBookSwitch<Adapter> modelSwitch =
		new AddressBookSwitch<Adapter>() {
			...
			@Override
			public Adapter caseContactCollection(ContactCollection object) {
				return createContactCollectionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link AddressBook.ContactCollection <em>Contact Collection</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createContactCollectionAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link AddressBook.Person <em>Person</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
