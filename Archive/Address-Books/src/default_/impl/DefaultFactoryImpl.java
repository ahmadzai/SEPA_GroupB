...
public class DefaultFactoryImpl extends EFactoryImpl implements DefaultFactory {
	...
	public static DefaultFactory init() {
		try {
			DefaultFactory theDefaultFactory = (DefaultFactory)EPackage.Registry.INSTANCE.getEFactory("http:///default.ecore"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DefaultPackage.STRING: return createString();
			case DefaultPackage.INT: return createInt();
			default:
	 ...
	 * @generated
	 */
	public default_.String createString() {
