...
public class DefaultAdapterFactory extends AdapterFactoryImpl {
	...
	protected DefaultSwitch<Adapter> modelSwitch =
		new DefaultSwitch<Adapter>() {
			@Override
			public Adapter caseString(default_.String object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link default_.String <em>String</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link default_.Int <em>Int</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
