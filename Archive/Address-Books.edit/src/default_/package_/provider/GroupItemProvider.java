...
/**
 * This is the item provider adapter for a {@link default_.package_.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addGroup_NamePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_Group_ID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_Group_ID_feature", "_UI_Group_type"),
				 PackagePackage.Literals.GROUP__GROUP_ID,
				 true,
				 false,
				 false,
				 null,
	 ...
	 * @generated
	 */
	protected void addGroup_NamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_Group_Name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_Group_Name_feature", "_UI_Group_type"),
				 PackagePackage.Literals.GROUP__GROUP_NAME,
				 true,
				 false,
				 false,
				 null,
